...
pmgConfig.theme = 'bluePMG'; // Theme values: 'redPMG', 'bluePMG', 'greenPMG', 'custom'. Default: 'redPMG'.
...
pmgConfig.galleryPerPage = 12; // ONLY CHANGE IF YOU CAN CHANGE CSS AS WELL. Default: 9.
