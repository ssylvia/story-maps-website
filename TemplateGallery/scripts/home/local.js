...
function buildMapPlaylist(obj,data){
	...
	if(totalItems > 0){
		...
		for(var i=0; i < forTotal; ++i) {
			var appClass = '';
			var detailsURL = "http://www.arcgis.com/home/item.html?id=" + data.results[i].id;
			// IF ITEM HAS URL
